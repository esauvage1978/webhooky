...
final class Version20260404210000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        if ($this->connection->getDatabasePlatform() instanceof SQLitePlatform) {
            $this->addSql('DROP INDEX UNIQ_webhooky_user_organization');
            $this->addSql('CREATE INDEX IDX_webhooky_user_organization ON "user" (organization_id)');
    ...
    public function down(Schema $schema): void
    {
        if ($this->connection->getDatabasePlatform() instanceof SQLitePlatform) {
            ...
            $this->addSql('DROP INDEX IDX_webhooky_user_organization');
            ...
            $this->addSql('DROP INDEX IDX_webhooky_user_organization ON `user`');
            $this->addSql('CREATE UNIQUE INDEX UNIQ_webhooky_user_organization ON `user` (organization_id)');
        }
    }
}
