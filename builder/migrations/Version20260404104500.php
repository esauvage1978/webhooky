...
final class Version20260404104500 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `user` ADD CONSTRAINT FK_zapier_user_organization FOREIGN KEY (organization_id) REFERENCES organization (id) ON DELETE SET NULL');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_zapier_user_organization ON `user` (organization_id)');
    }

    public function down(Schema $schema): void
    {
        $this->addSql('ALTER TABLE `user` DROP FOREIGN KEY FK_zapier_user_organization');
