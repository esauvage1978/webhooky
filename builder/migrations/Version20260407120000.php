...
final class Version20260407120000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('UPDATE `user` SET display_name = SUBSTRING_INDEX(email, \'@\', 1), avatar_key = \'p01\', profile_completed_at = NOW(), plan_onboarding_completed = 1 WHERE profile_completed_at IS NULL');
    }
