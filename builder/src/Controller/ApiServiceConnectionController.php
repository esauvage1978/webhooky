...
use App\ServiceIntegration\ServiceConnectionConfigValidator;
...
final class ApiServiceConnectionController extends AbstractController
{
    public function __construct(
        ...
        private readonly ServiceConnectionConfigValidator $configValidator,
    ) {
    }
    ...
    public function create(Request $request): JsonResponse
    {
        ...
        $config = $configRaw;
        $cfgErr = $this->configValidator->validateShape($type, $config);
        if ($cfgErr !== null) {
    ...
    public function update(int $id, Request $request): JsonResponse
    {
        ...
        if (\array_key_exists('config', $data)) {
            ...
            $cfgErr = $this->configValidator->validateShape($s->getType(), $config);
            if ($cfgErr !== null) {
                return new JsonResponse(['error' => $cfgErr], Response::HTTP_BAD_REQUEST);
            }
            $s->setConfig($this->secretHelper->encryptSensitiveFields($config));
